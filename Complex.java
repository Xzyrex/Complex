public class Complex {
    ...
    String toExponential(){
        return String.format("%f*e^%3.3f * i",r,angle*57.2958);
                //r +"*e^" + angle*57.2958 + "i";
    }

    String toTrigonometrical(){
        return  String.format("%f*(cos(%3.3f) + sin(%3.3f) * i)",r,angle*57.2958,angle*57.2958);
        //r + "(cos(" + angle*57.2958 + ") + sin(" + angle*57.2958 + ")*i)"
    }

    String toAlgebraic(){
        String pl = imaginary>=0?" + ":" ";
        return String.format("%f %s %f * i",real,pl,imaginary);
                //real + pl + imaginary + "i";
    }
}
